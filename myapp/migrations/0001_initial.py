# Generated by Django 2.1.2 on 2018-10-27 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_terms', to='myapp.Course')),
            ],
            options={
