...
- [drf-spectacular-jsonapi example](#drf-spectacular-jsonapi-example)
- [Differences vs. API](#differences-vs-api)
  * [Missing HTTP links and Meta](#missing-http-links-and-meta)
  * [Breaks on RelationShipViews](#breaks-on-relationshipviews)
  * [Related field not handled](#related-field-not-handled)
  * [Does not (yet) support non-model serializers](#does-not-yet-support-non-model-serializers)

<!-- tocstop -->

This is a comparison of the OAS schemas generated by drf-spectacular-jsonapi vs.
