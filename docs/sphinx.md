...
### reStructedText (RST) vs. Markdown (MD)
...
We use [Confluence](https://confluence.columbia.edu) for an internal documentation repository.

TODO: Document how to publish to confluence
